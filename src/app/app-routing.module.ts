...
import { HistoryaddComponent } from './cruduser/historyadd/historyadd.component';
...
const routes: Routes = [
  ...
  {
    path:'payment-offer/:id' , component:PaymentComponent
  },
  {
    path:'payment-offer/:id/:em' , component:PaymentComponent
  },
  ...
  },
{
  ...
  },
  {
    ...
    {
      path:'paysuc' ,component:PaysucceessComponent
    },
    {
      path:'paysuc/:id/:em' ,component:PaysucceessComponent
    },
    // {
    //   path:'history/:mes' , component:HistoryComponent
    // }
    {
      path:'history/:id/:em',component:HistoryComponent
    }
